...
const RAW: RawMember[] = [
  {
    ...
    bubbles: {
      es: [
        ...
        { who: 'out', text: 'Aquí va el link para dejar el anticipo:', link: 'pay.rayhealth.app/c/aurora-4821', t: '23:43' },
        { who: 'out', text: 'Pago recibido. Tu primera sesión queda confirmada: jueves 17:30. Un día antes te escribo para confirmar.', t: '23:45' },
        { who: 'out', text: 'Hola, te escribo de la clínica. Mañana jueves a las 17:30 tienes tu primera sesión de piernas enteras. ¿Confirmas que vienes?', t: '10:00' },
        { who: 'in', text: 'Sí, confirmado', t: '10:12' },
        { who: 'out', text: 'Perfecto, te esperamos. Si necesitas cambiar algo, escríbeme por aquí.', t: '10:12' },
      ],
      en: [
        ...
        { who: 'out', text: 'Here’s the link for the deposit:', link: 'pay.rayhealth.app/c/aurora-4821', t: '11:43' },
        { who: 'out', text: 'Payment received. Your first session is confirmed: Thursday 5:30pm. I’ll message you the day before to confirm.', t: '11:45' },
        { who: 'out', text: 'Hi, it’s the clinic. Tomorrow, Thursday at 5:30pm, you have your first full-legs session. Can you confirm you’re coming?', t: '10:00' },
        { who: 'in', text: 'Yes, confirmed', t: '10:12' },
        { who: 'out', text: 'Perfect, see you then. If anything changes, message me here.', t: '10:12' },
      ],
    },
