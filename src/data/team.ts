...
const RAW: RawMember[] = [
...

  {
    ...
    tag: { es: 'Trabajando ahora', en: 'Working now' },
    oneliner: {
      es: 'Cuida tu Instagram y te propone la promo cuando la agenda afloja.',
      en: 'Looks after your Instagram and pitches the promo when the calendar dips.',
    },
    metaTitle: {
      es: 'Mia · Marketing con IA que cuida tu Instagram y te propone promos',
      en: 'Mia · AI marketing that runs your Instagram and pitches promos',
    },
    metaDescription: {
      es: 'Mia es la marketinera con IA de tu clínica. Entiende tu Instagram, propone ideas y, cuando ve días flojos, te escribe con una promo lista. La apruebas por chat y la publica.',
      en: 'Mia is your clinic’s AI marketer. She understands your Instagram, pitches ideas and, when she sees slow days, messages you with a ready promo. You approve over chat and she publishes it.',
    },
    heroEyebrow: { es: 'Mia · Marketing', en: 'Mia · Marketing' },
    heroTitle: {
      es: "Ve el hueco en tu agenda <em class='text-pine-dark'>y te escribe.</em>",
      en: "Spots the gap in your calendar <em class='text-pine-dark'>and writes you.</em>",
    },
    heroLead: {
      es: 'Mia es la marketinera con IA de tu clínica. Entiende tu feed, propone ideas y arma las piezas. Su diferencia: es proactiva. Mira tu agenda y, cuando ve días flojos, te propone la promo para llenarlos.',
      en: 'Mia is your clinic’s AI marketer. She understands your feed, pitches ideas and builds the pieces. What sets her apart: she’s proactive. She watches your calendar and, when she sees slow days, pitches the promo to fill them.',
    },
    kicker: { es: 'Cómo trabaja Mia', en: 'How Mia works' },
    h2: {
      es: 'Mia no espera el brief. <em class="text-pine-dark">Ve el hueco y te escribe.</em>',
      en: 'Mia doesn’t wait for a brief. <em class="text-pine-dark">She spots the gap and writes you.</em>',
    },
    paragraph: {
      es: 'Mia entiende tu feed, propone ideas y arma las piezas. Pero su diferencia es que es proactiva: mira tu agenda, y cuando ve días flojos te escribe con una promo lista para llenarlos. La apruebas por chat y ella la publica. Tú no abriste nada; Mia ya estaba trabajando.',
      en: 'Mia understands your feed, pitches ideas and builds the pieces. But what sets her apart is that she’s proactive: she watches your calendar, and when she sees slow days she messages you with a promo ready to fill them. You approve it over chat and she publishes it. You opened nothing; Mia was already working.',
    },
    points: {
      es: [
        'Entiende tu Instagram y propone qué publicar',
        'Detecta los días flojos antes que tú',
        'Lanza la promo cuando la apruebas, sin que muevas un dedo',
      ],
      en: [
        'Understands your Instagram and pitches what to post',
        'Catches the slow days before you do',
        'Launches the promo once you approve, hands off',
      ],
    },
    ...
    bubbles: {
      es: [
        ...
        { who: 'out', text: 'Propuesta: "Botox jueves y viernes, agenda con anticipo y llevas la segunda zona a mitad de precio". Pieza para feed y story lista. ¿La lanzo?', t: '09:12' },
        { who: 'in', text: 'Dale, pero bajá el descuento a 30%', t: '09:20' },
        { who: 'out', text: '¡Listo! Ajusté al 30% y ya la publiqué en feed e historia. A quien responda lo agendo y le cobro el anticipo yo misma. Te aviso cómo va. 📈', t: '09:21' },
      ],
      en: [
        ...
        { who: 'out', text: 'Idea: "Botox Thursday & Friday, book with a deposit and get the second area half off." Feed and story pieces are ready. Want me to launch?', t: '09:12' },
        { who: 'in', text: 'Go for it, but drop the discount to 30%', t: '09:20' },
        { who: 'out', text: 'Done! Set it to 30% and published to feed and story. Anyone who replies, I book and take the deposit myself. I’ll keep you posted. 📈', t: '09:21' },
      ],
    },
